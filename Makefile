...
DOCS_SOURCE_FILES = $(filter-out docs/v0.3.0/%, $(filter docs/%, $(ALL_SOURCE_FILES)))
...
.make.docs: $(DOCS_SOURCE_FILES) $(PY_SOURCE_FILES) $(RST_SOURCE_FILES)
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
	sed -i 's/</\n</g' docs/v0.3.0/html/*.html
	@echo "Results in docs/v0.3.0/html/index.html"
	touch $@
