...
`documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.1.0/adapters.html>`__ for details.

The Julia package has support for creating self-documenting computations (see the Julia
`documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.1.0/computations.html>`__ for details) which explicitly
declare a contract describing the inputs and outputs of the computation (see the Julia
`documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.1.0/contracts.html>`__ for details). The Python package
...
def adapter(
    ...
    *,
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.1.0/adapters.html#DataAxesFormats.Adapters.adapter>`__
    for details.
    """
    base_name = daf.name
