...
class QueryOperation(JlObject):
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/registry.html#DataAxesFormats.Registry.QueryOperation>`__
    for details.
...
class QuerySequence(QueryOperation):
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/queries.html#DataAxesFormats.Queries.QuerySequence>`__
    for details.
...
class EltwiseOperation(QueryOperation):
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/registry.html#DataAxesFormats.Registry.EltwiseOperation>`__
    for details.
    """
...
class ReductionOperation(QueryOperation):
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/registry.html#DataAxesFormats.Registry.ReductionOperation>`__
    for details.
    """
...
class Abs(EltwiseOperation):
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/operations.html#DataAxesFormats.Operations.Abs>`__
    for details.
    """
...
class Round(EltwiseOperation):
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/operations.html#DataAxesFormats.Operations.Round>`__
    for details.
    """
...
class Clamp(EltwiseOperation):
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/operations.html#DataAxesFormats.Operations.Clamp>`__
    for details.
    """
...
class Convert(EltwiseOperation):
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/operations.html#DataAxesFormats.Operations.Convert>`__
    for details.
    """
...
class Fraction(EltwiseOperation):
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/operations.html#DataAxesFormats.Operations.Fraction>`__
    for details.
    """
...
class Log(EltwiseOperation):
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/operations.html#DataAxesFormats.Operations.Log>`__
    for details.
    """
...
class Significant(EltwiseOperation):
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/operations.html#DataAxesFormats.Operations.Significant>`__
    for details.
    """
...
class Sum(ReductionOperation):
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/operations.html#DataAxesFormats.Operations.Sum>`__
    for details.
    """
...
class Min(ReductionOperation):
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/operations.html#DataAxesFormats.Operations.Min>`__
    for details.
    """
...
class Median(ReductionOperation):
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/operations.html#DataAxesFormats.Operations.Median>`__
    for details.
    """
...
class Quantile(ReductionOperation):
    ...
    lower. See the Julia
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/operations.html#DataAxesFormats.Operations.Quantile>`__
    for details.
    """
...
class Mean(ReductionOperation):
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/operations.html#DataAxesFormats.Operations.Mean>`__
    for details.
    """
...
class Max(ReductionOperation):
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/operations.html#DataAxesFormats.Operations.Max>`__
    for details.
    """
...
class Var(ReductionOperation):
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/operations.html#DataAxesFormats.Operations.Var>`__
    for details.
    """
...
class VarN(ReductionOperation):
    ...
    the Julia `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/operations.html#DataAxesFormats.Operations.VarN>`__
    for details.
    """
...
class Std(ReductionOperation):
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/operations.html#DataAxesFormats.Operations.Std>`__
    for details.
    """
...
class StdN(ReductionOperation):
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/operations.html#DataAxesFormats.Operations.StdN>`__
    for details.
    """
