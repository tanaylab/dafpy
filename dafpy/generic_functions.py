...
`documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.1.0/generic.html>`__ for details.
"""
...
#: `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.1.0/generic.html#Daf.Generic.AbnormalHandler>`__ for
#: details.
...
def inefficient_action_handler(handler: AbnormalHandler) -> AbnormalHandler:
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.1.0/generic_functions.html#Daf.MatrixLayouts.inefficient_action_handler>`__
    for details.
    """
