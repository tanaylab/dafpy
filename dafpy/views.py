...
`documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.1.0/views.html>`__
for details.
"""
...
#: `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.1.0/views.html#Daf.Views.ALL_SCALARS>`__
#: for details.
ALL_SCALARS = "*"

#: A pair to use in the ``axes`` parameter of ``viewer`` to specify all the base data axes. See the Julia
#: `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.1.0/views.html#Daf.Views.ALL_AXES>`__
#: for details.
ALL_AXES = "*"

#: A key to use in the ``data`` parameter of ``viewer`` to specify all the vectors of the exposed axes. See the Julia
#: `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.1.0/views.html#Daf.Views.ALL_VECTORS>`__
#: for details.
ALL_VECTORS = ("*", "*")

#: A key to use in the ``data`` parameter of ``viewer`` to specify all the matrices of the exposed axes. See the Julia
#: `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.1.0/views.html#Daf.Views.ALL_MATRICES>`__
#: for details.
ALL_MATRICES = ("*", "*", "*")

#: Specify axes to expose from a view. See the Julia
#: `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.1.0/views.html#Daf.Views.ViewAxes>`__
#: for details.
#:
...
def viewer(
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.1.0/views.html#Daf.Views.viewer>`__
    for details.
