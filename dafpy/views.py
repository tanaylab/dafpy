...
`documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/views.html>`__
for details.
"""
...
#: `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/views.html#DataAxesFormats.Views.ALL_SCALARS>`__
#: for details.
ALL_SCALARS = "*"

#: A pair to use in the ``axes`` parameter of ``viewer`` to specify all the base data axes. See the Julia
#: `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/views.html#DataAxesFormats.Views.ALL_AXES>`__
#: for details.
ALL_AXES = "*"

#: A key to use in the ``data`` parameter of ``viewer`` to specify all the vectors of the exposed axes. See the Julia
#: `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/views.html#DataAxesFormats.Views.ALL_VECTORS>`__
#: for details.
ALL_VECTORS = ("*", "*")

#: A key to use in the ``data`` parameter of ``viewer`` to specify all the matrices of the exposed axes. See the Julia
#: `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/views.html#DataAxesFormats.Views.ALL_MATRICES>`__
#: for details.
ALL_MATRICES = ("*", "*", "*")

#: Specify axes to expose from a view. See the Julia
#: `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/views.html#DataAxesFormats.Views.ViewAxes>`__
#: for details.
#:
...
#: `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/views.html#DataAxesFormats.Views.ViewData>`__
#: for details.
#:
#: Note that in Python this is a dictionary and not a vector. This allows using the ``key: value`` notation,
#: and preserves the order of the entries since in Python dictionaries are ordered by default.
...
def viewer(
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/views.html#DataAxesFormats.Views.viewer>`__
    for details.
