...
`documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/formats.html>`__,
`documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/readers.html>`__ and
`documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/writers.html>`__
for details.
"""
...
#: `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/keys.html#DataAxesFormats.Keys.PropertyKey>`__
#: for details.
...
#: `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/keys.html#DataAxesFormats.Keys.DataKey>`__
#: for details.
...
class DafReader(JlObject):
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/formats.html#DataAxesFormats.Formats.DafReader>`__
    for details.
    """
    ...
    def has_scalar(self, name: str) -> bool:
        ...
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/readers.html#DataAxesFormats.Readers.has_scalar>`__
        for details.
        """
        return jl.DataAxesFormats.has_scalar(self.jl_obj, name)

    @overload
    def get_scalar(self, name: str, *, default: None) -> Optional[StorageScalar]: ...

    @overload
    def get_scalar(self, name: str, *, default: StorageScalar | UndefInitializer = Undef) -> StorageScalar: ...

    def get_scalar(self, name, *, default: None | StorageScalar | UndefInitializer = Undef) -> Optional[StorageScalar]:
        """
        Get the value of a scalar property with some ``name`` in the ``Daf`` data set. See the Julia
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/readers.html#DataAxesFormats.Readers.get_scalar>`__
        for details.
        ...
        """
        return jl.DataAxesFormats.get_scalar(self.jl_obj, name, default=default)

    def scalars_set(self) -> AbstractSet[str]:
        """
        The names of the scalar properties in the ``Daf`` data set. See the Julia
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/readers.html#DataAxesFormats.Readers.scalars_set>`__
        for details.
        """
    ...
    def has_axis(self, axis: str) -> bool:
        ...
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/readers.html#DataAxesFormats.Readers.has_axis>`__
        for details.
        """
    ...
    def axes_set(self) -> AbstractSet[str]:
        ...
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/readers.html#DataAxesFormats.Readers.axes_set>`__
        for details.
        """
    ...
    def axis_length(self, axis: str) -> int:
        ...
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/readers.html#DataAxesFormats.Readers.axis_length>`__
        for details.
        """
    ...
    def axis_np_vector(self, axis: str) -> np.ndarray:
        ...
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/readers.html#DataAxesFormats.Readers.axis_vector>`__
        for details.
    ...
    def axis_np_entries(
        ...
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/readers.html#DataAxesFormats.Readers.axis_entries>`__
        for details.
    ...
    def axis_np_indices(self, axis: str, entries: Sequence[str], *, allow_empty: bool = False) -> np.ndarray:
        ...
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/readers.html#DataAxesFormats.Readers.axis_indices>`__
        for details.
    ...
    def has_vector(self, axis: str, name: str) -> bool:
        ...
        Julia
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/readers.html#DataAxesFormats.Readers.has_vector>`__
        for details.
        """
    ...
    def vectors_set(self, axis: str) -> AbstractSet[str]:
        ...
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/readers.html#DataAxesFormats.Readers.vectors_set>`__
        for details.
        """
    ...
    def get_np_vector(
        ...
        *,
        ...
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/readers.html#DataAxesFormats.Readers.get_vector>`__
        for details.
    ...
    def matrices_set(
        self, rows_axis: str, columns_axis: str, *, tensors: Optional[bool] = None, relayout: Optional[bool] = None
    ) -> AbstractSet[str]:
        """
        ...
        for details.
        """
        return jl.DataAxesFormats.matrices_set(
            self.jl_obj, rows_axis, columns_axis, **_given(tensors=tensors, relayout=relayout)
        )
    ...
    def get_np_matrix(
        ...
        *,
        ...
        ``Daf`` data set. See the Julia
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/readers.html#DataAxesFormats.Readers.get_matrix>`__
        for details.
    ...
    def empty_cache(self, *, clear: Optional[CacheGroup] = None, keep: Optional[CacheGroup] = None) -> None:
        ...
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/formats.html#DataAxesFormats.Formats.empty_cache!>`__
        for details.
        """
    ...
    def has_query(self, query: str | Query) -> bool:
        ...
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/queries.html#DataAxesFormats.Queries.has_query>`__
        for details.
        """
    ...
    def query_requires_relayout(self, query: str | Query) -> bool:
        ...
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/queries.html#DataAxesFormats.Queries.query_requires_relayout>`__
        for details.
        """
    ...
    def get_np_query(
        ...
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/queries.html#DataAxesFormats.Queries.get_query>`__
        for details.
    ...
    def get_pd_frame(
        ...
        *,
        ...
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/queries.html#DataAxesFormats.Queries.get_frame>`__
        for details.
    ...
    def read_only(self, *, name: Optional[str] = None) -> "DafReadOnly":
        ...
        Julia
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/read_only.html#DataAxesFormats.ReadOnly.read_only>`__
        for details.
        """
    ...
    def complete_path(self) -> Optional[str]:
        ...
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/readers.html#DataAxesFormats.Readers.complete_path>`__
        for details.
        """
...
class DafReadOnly(DafReader):
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/read_only.html#DataAxesFormats.ReadOnly.DafReadOnly>`__
    for details.
    """
...
class DafWriter(DafReader):
    ...
    def delete_scalar(self, name: str, *, must_exist: bool = True) -> Self:
        ...
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/writers.html#DataAxesFormats.Writers.delete_scalar!>`__
        for details.
    ...
    def delete_axis(self, axis: str, *, must_exist: bool = True) -> Self:
        ...
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/writers.html#DataAxesFormats.Writers.delete_axis!>`__
        for details.
    ...
    def set_vector(
        ...
        *,
        ...
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/writers.html#DataAxesFormats.Writers.set_vector!>`__
        for details.
        ...
        if (isinstance(value, sp.csc_matrix) and value.shape[1] == 1) or (
            ...
            with self.empty_sparse_vector(
                axis,
                name,
                eltype or value.data.dtype,
                value.nnz,
                value.indptr.dtype,
                **_given(overwrite=overwrite, packed=packed),
            ) as (nzind, nzval):
                nzind[:] = value.indices[:]
                nzind += 1
                nzval[:] = value.data[:]
        ...
        jl.DataAxesFormats.set_vector_b(
            ...
            axis,
            name,
            _as_vector(_to_julia_array(value)),
            **_given(eltype=_to_julia_type(eltype), overwrite=overwrite, packed=packed),
        )
        return self

    @contextmanager
    def empty_dense_vector(
        self, axis: str, name: str, eltype: Type, *, overwrite: Optional[bool] = None, packed: Optional[bool] = None
    ) -> Iterator[np.ndarray]:
        """
        ...
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/writers.html#DataAxesFormats.Writers.empty_dense_vector!>`__
        for details.
        ...
        vector, cache_group = jl.DataAxesFormats.get_empty_dense_vector_b(
            self.jl_obj, axis, name, _to_julia_type(eltype), **_given(overwrite=overwrite, packed=packed)
        )
        try:
    ...
    def empty_sparse_vector(  # pylint: disable=too-many-positional-arguments
        ...
        *,
        ...
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/writers.html#DataAxesFormats.Writers.empty_sparse_vector!>`__
        for details.
    ...
    def delete_vector(self, axis: str, name: str, *, must_exist: bool = True) -> Self:
        ...
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/writers.html#DataAxesFormats.Writers.delete_vector!>`__
        for details.
    ...
    def set_matrix(
        ...
        *,
        ...
        See the Julia
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/writers.html#DataAxesFormats.Writers.set_matrix!>`__
        for details.
        ...
        jl.DataAxesFormats.set_matrix_b(
            ...
            **_given(eltype=_to_julia_type(eltype), overwrite=overwrite, relayout=relayout, packed=packed),
        )
        return self
    ...
    def empty_dense_matrix(  # pylint: disable=too-many-positional-arguments
        ...
        *,
        ...
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/writers.html#DataAxesFormats.Writers.empty_dense_matrix!>`__
        for details.
        ...
        matrix, cache_group = jl.DataAxesFormats.get_empty_dense_matrix_b(
            ...
            name,
            _to_julia_type(eltype),
            **_given(overwrite=overwrite, relayout=relayout, packed=packed),
        )
        try:
    ...
    def empty_sparse_matrix(  # pylint: disable=too-many-positional-arguments
        ...
        *,
        ...
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/writers.html#DataAxesFormats.Writers.empty_sparse_matrix!>`__
        for details.
    ...
    def relayout_matrix(
        ...
        *,
        ...
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/writers.html#DataAxesFormats.Writers.relayout_matrix!>`__
        for details.

        Returns ``self`` for chaining.
        """
        jl.DataAxesFormats.relayout_matrix_b(
            self.jl_obj, rows_axis, columns_axis, name, **_given(overwrite=overwrite, packed=packed)
        )
        return self

    def delete_matrix(
        self, rows_axis: str, columns_axis: str, name: str, *, must_exist: bool = True, relayout: Optional[bool] = None
    ) -> Self:
        """
        Delete a matrix property with some ``name`` for some ``rows_axis`` and ``columns_axis`` from the ``Daf`` data
        set. See the Julia
        `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.3.0/writers.html#DataAxesFormats.Writers.delete_matrix!>`__
        for details.

        Returns ``self`` for chaining.
        """
        jl.DataAxesFormats.delete_matrix_b(
            self.jl_obj, rows_axis, columns_axis, name, must_exist=must_exist, **_given(relayout=relayout)
        )
        return self
