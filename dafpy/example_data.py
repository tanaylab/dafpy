...
`documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.2.0/example_data.html>`__ for details.
"""
...
def example_cells_daf(
    *,
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.2.0/example_data.html#DataAxesFormats.ExampleData.example_cells_daf>`__
    for details.
    """
...
def example_metacells_daf(
    *,
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.2.0/example_data.html#DataAxesFormats.ExampleData.example_metacells_daf>`__
    for details.
    """
...
def example_chain_daf(
    *,
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.2.0/example_data.html#DataAxesFormats.ExampleData.example_chain_daf>`__
    for details.
    """
