...
`documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.2.0/anndata_format.html>`__ for details.
"""
...
def h5ad_as_daf(
    ...
    *,
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.2.0/anndata_format.html#DataAxesFormats.AnnDataFormat.anndata_as_daf>`__ for
    details.
...
def daf_as_h5ad(
    ...
    `documentation <https://tanaylab.github.io/DataAxesFormats.jl/v0.2.0/anndata_format.html#DataAxesFormats.AnnDataFormat.daf_as_anndata>`__
    for details.
